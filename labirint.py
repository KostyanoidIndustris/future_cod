...
window.blit(transform.scale(fon, (win_width, win_height)), (0, 0))
...
w1 = GameSprite('derevo_2.png',win_width / 2 - win_width / 4, win_height / 150, 80, 280)
w3 = GameSprite('derevo_1.png', 95, 200, 150, 100)
w2 = GameSprite('derevo_2.png',win_width / 2 - win_width / 180, win_height / 4.2, 80, 400)
...
#создаем спрайты
packman = Player('hero.png', 5, win_height - 75, 75, 70, 0, 0)
final_sprite = GameSprite('win_point.png', win_width - 120, win_height - 100, 120, 100)


monster1 = Enemy('bad_hero.png', win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('bad_hero.png', win_width - 80, 230, 80, 80, 5)
...
#проверка, что игра еще не завершена
 if not finish:
     ...
     window.blit(fon,(0,0))#закрашиваем окно цветом
